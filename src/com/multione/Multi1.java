...
public class Multi1 extends Main {
    ...
    public void start(Stage primaryStage) {
        ...
        Pane myOverlay = overlayGen.getOverlay("com/multione/Resource/map2new.png", 0, 0, 1024, 768);
...
//
        ...
        Pane enemy = characterGen2.getCharacter("com/multione/Resource/evilelectron.png", 900, 510, 25);
        root.getChildren().addAll(enemy);

        Enemy enemy1 = new Enemy();
        root.getChildren().addAll(enemy1.getEnemy("com/multione/Resource/evilelectron.png", 900, 510, 25));

        Enemy enemy2 = new Enemy();
        root.getChildren().addAll(enemy2.getEnemy("com/multione/Resource/evilelectron.png", 900, 510, 25));
        ...
        //Performs character and enemy action from the keys pressed
        ...
        //Stops character and enemy action after key released
        ...
        //Controls movement of character and enemy inside maze
        timer = new AnimationTimer() {
            ...
            public void handle(long now) {
                if (isTimerOn && isCountDownOver) {
                    ...
                    if (((Math.abs(myCharacter.getTranslateX() - enemy.getTranslateX()) < 30 && Math.abs(myCharacter.getTranslateY() - enemy.getTranslateY()) < 30) ||
                            (Math.abs(myCharacter.getTranslateX() - enemy1.enemy.getTranslateX()) < 30 && Math.abs(myCharacter.getTranslateY() - enemy1.enemy.getTranslateY()) < 30) ||
                    ...
                    //Speed of enemy
                    if (enemyMoveUp && enemy.getTranslateY() > 0 && !characterGen2.isColliding(map, KeyCode.UP, true)) {
                        edy -= 5;
                    } else if (enemyMoveDown && enemy.getTranslateY() < 736 && !characterGen2.isColliding(map, KeyCode.DOWN, true)) {
                        edy += 5;
                    } else if (enemyMoveRight && enemy.getTranslateX() < 992 && !characterGen2.isColliding(map, KeyCode.RIGHT, true)) {
                        edx += 5;
                    } else if (enemyMoveLeft && enemy.getTranslateX() > 0 && !characterGen2.isColliding(map, KeyCode.LEFT, true)) {
                        edx -= 5;
                    }
                    ...
                    ey += edy + enemy.getTranslateY();
                    ex += edx + enemy.getTranslateX();


                    myCharacter.setTranslateY(y);
                    myCharacter.setTranslateX(x);

                    enemy.setTranslateX(ex);
                    enemy.setTranslateY(ey);

                    //Starts AI enemy movement after a certain period of time in the game
                    enemy1.startEnemyMovement(map, 3, 120 - timeSeconds);
                    enemy2.startEnemyMovement(map, 6, 120 - timeSeconds);
                    enemy3.startEnemyMovement(map, 9, 120 - timeSeconds);
