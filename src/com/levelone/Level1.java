...
public class Level1 extends Main {
    ...
    public void start(Stage primaryStage) {
        ...
        Pane myOverlay = overlayGen.getOverlay("com/levelone/Resource/map1new.png", 0, 0, 1024, 768);
        ...
        Pane myCharacter = characterGen.getCharacter("com/levelone/Resource/electrongreen.png", 90, 60, 25);
        root.getChildren().addAll(myCharacter);

        Enemy enemy1 = new Enemy();
        root.getChildren().addAll(enemy1.getEnemy("com/levelone/Resource/evilelectron.png", 90, 120, 25));

        Enemy enemy2 = new Enemy();
        root.getChildren().addAll(enemy2.getEnemy("com/levelone/Resource/evilelectron.png", 90, 120, 25));

        Enemy enemy3 = new Enemy();
        root.getChildren().addAll(enemy3.getEnemy("com/levelone/Resource/evilelectron.png", 90, 120, 25));

        Enemy enemy4 = new Enemy();
        root.getChildren().addAll(enemy4.getEnemy("com/levelone/Resource/evilelectron.png", 90, 120, 25));
