...
public class Level3 extends Main {
    ...
    public void start(Stage primaryStage) {
        ...
        Pane myOverlay = overlayGen.getOverlay("com/levelthree/Resource/map3new.png", 0, 0, 1024, 768);
        ...
        Pane myCharacter = characterGen.getCharacter("com/levelthree/Resource/electrongreen.png", 60, 90, 25);
        root.getChildren().addAll(myCharacter);

        Enemy enemy1 = new Enemy();
        root.getChildren().addAll(enemy1.getEnemy("com/levelthree/Resource/evilelectron.png", 900, 630, 25));

        Enemy enemy2 = new Enemy();
        root.getChildren().addAll(enemy2.getEnemy("com/levelthree/Resource/evilelectron.png", 900, 630, 25));

        Enemy enemy3 = new Enemy();
        root.getChildren().addAll(enemy3.getEnemy("com/levelthree/Resource/evilelectron.png", 900, 630, 25));

        Enemy enemy4 = new Enemy();
        root.getChildren().addAll(enemy4.getEnemy("com/levelthree/Resource/evilelectron.png", 900, 630, 25));
